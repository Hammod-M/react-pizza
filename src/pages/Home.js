...
export const Home = ({}) => {
  ...
  const { categoriesActive, sortActive } = useSelector((state) => state.filter);
  ...
  async function getPizzas() {
    ...
    const category = categoriesActive > 0 ? `category=${categoriesActive}` : "";
  ...
  return (
    <div className="content">
      <div className="container">
        ...
        <Items pizzas={pizzas} isLoading={isLoading} searchVal={searchVal} />
